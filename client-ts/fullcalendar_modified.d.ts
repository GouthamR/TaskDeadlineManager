...
export interface Options extends AgendaOptions, EventDraggingResizingOptions, DroppingExternalElementsOptions, SelectionOptions {
    ...
    navLinks?: boolean; // ADDED BY GOUTHAMR
    ...
    eventLimit?: boolean;
    defaultTimedEventDuration?: string; // ADDED BY GOUTHAMR
    defaultAllDayEventDuration?: Object; // ADDED BY GOUTHAMR
    forceEventDuration?: boolean; // ADDED BY GOUTHAMR
